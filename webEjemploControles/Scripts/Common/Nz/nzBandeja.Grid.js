        ...
        switch (tipoColumna)
        {
            ...
            case context.tipoColumna.Link:
                if (parametros !== null && parametros !== undefined) {
                    if (parametros[0].IdTipoEnvioParametro === 1)
                    ...
                    result = $('<a href="' + link +'"></a>').addClass(clase).text(valor);
                }
    ...
    Bandeja.prototype.getLinkParametros = function (linkParametros, valor, datos) {
        ...
        for (var i = 0; i < linkParametros.length; i++) {
            if (linkParametros[i].IdTipoParametro == 1)
                strParametros += linkParametros[i].Parametro + '=' + linkParametros[i].Valor;
            else if (linkParametros[i].IdTipoParametro == 2)
                strParametros += linkParametros[i].Parametro + '=' + datos[linkParametros[i].Valor];
