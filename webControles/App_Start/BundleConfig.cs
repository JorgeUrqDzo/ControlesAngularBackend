    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        ...
                        "~/Scripts/app.min.js",
                        "~/Scripts/Plugin/toastr/toastr.js",
                        "~/Scripts/Common/messageCommon.js",
                        "~/Scripts/bootstrap-switch.min.js",
                        "~/Scripts/core/nz-switch.js",
                        "~/Scripts/bootstrap-select-1.10.0/js/bootstrap-select.js",
                        "~/Scripts/bootstrap-select-1.10.0/dist/js/bootstrap-select.min.js",
